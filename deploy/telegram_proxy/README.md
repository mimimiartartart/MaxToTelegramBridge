...
Этот каталог нужен, если вы хотите оставить MAX и всю бизнес-логику на РФ сервере, а трафик Telegram отправлять через зарубежный.
...
Ниже команды для Ubuntu/Debian
